...
(function () {
  ...
  var envGlobal = hasSelf ? $global.self : global;

  var baseUrl;

  if (hasDocument) {
    var baseEl = $global.document.querySelector('base[href]');
    if (baseEl)
      baseUrl = baseEl.href;
  }

  if (!baseUrl && typeof location !== 'undefined') {
    baseUrl = $global.location.href.split('#')[0].split('?')[0];
  ...
  })(typeof self !== 'undefined' ? $global.self : global);
