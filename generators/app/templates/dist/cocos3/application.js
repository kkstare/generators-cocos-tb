...
$global.System.register([], function (_export, _context) {
  "use strict";
  ...
  function createApplication(_ref) {
    ...
    function loadAssetBundle(hasResourcesBundle, hasStartSceneBundle) {
      var promise = Promise.resolve();
      var _cc$AssetManager$Buil = $global.cc.AssetManager.BuiltinBundleName,
    ...
    function loadBundle(name) {
      return new Promise(function (resolve, reject) {
        $global.cc.assetManager.loadBundle(name, function (err, bundle) {
          if (err) {
            return reject(err);
          }
    ...
    function loadSettingsJson(cc) {var settings = 'src/setting.js';return new Promise(function (resolve, reject) {require('./' + settings);resolve();});}
		function loadSettingsJson1(cc) {
      var server = '';
      var settings = 'src/settings.json';
      return new Promise(function (resolve, reject) {
        if (typeof window.fsUtils !== 'undefined' && !settings.startsWith('http')) {
          var result = $global.fsUtils.readJsonSync(settings);
