...
if (info.platform == "iOS") {
    $global.canvas.width *= info.pixelRatio;
    $global.canvas.height *=  info.pixelRatio;
} else {
    $global.canvas.width = info.screenWidth;
    $global.canvas.height = info.screenHeight;
}
...
$global.System.import('./application.js').then(({ createApplication }) => {
