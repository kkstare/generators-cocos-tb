...
function Canvas() {
    var canvas = my.createOffscreenCanvas ? my.createOffscreenCanvas() : my.createCanvas();
...
var Image = function () {
    function Image() {
        var img = $global.webglContext.createImage();
...
window.requestAnimationFrame = screencanvas.requestAnimationFrame.bind(screencanvas);
window.cancelAnimationFrame = screencanvas.cancelAnimationFrame.bind(screencanvas);
